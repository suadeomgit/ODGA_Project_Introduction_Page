...
function checkFav(favEle) {
    ...
    console.log(bb);
    if(bb=='background-image: url("./Seong/image/heart2.png");'){
        favEle.setAttribute("style", 'background-image: url("./Seong/image/heart1.png");');
        $('#fav>.music-list-card').remove("."+id+""); 
    }else if(bb=='background-image: url("./Seong/image/heart1.png");'){
        favEle.setAttribute("style", 'background-image: url("./Seong/image/heart2.png");');
                            ...
                            <div class="right-part">\
                                ...
                                <div class="playing-indicator">\
                                    <div class="fav-blank" onclick="checkFav(this)" \
                                        ...
                                        style="background-image: url("./Seong/image/heart2.png")">\
                                    </div>\
                                </div>\
                            </div>\
                        </div>');
